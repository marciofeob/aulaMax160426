...
* RF04 — Regularidade do Aluno: O sistema deve verificar automaticamente se o **aluno** está com a **mensalidade** em dia.
...
* RF07 — Lista de Presença: Os instrutores devem registrar a **presença** dos **alunos** nas **aulas**.
* RF08 — Avaliação Física: Os instrutores devem registrar **avaliações** físicas (**peso**, **IMC**, **percentual** de **gordura** etc.) e anexar **arquivos** se necessário.
